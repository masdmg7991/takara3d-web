...
- `OrderFulfillment.gs`: política de cumplimiento STORE-only; autoriza recogida en tienda únicamente con Store ACTIVE y punto físico válido, con coste de entrega `0.00 EUR`.
...
- LIVE verificado por GET: TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_19_0_STORE_URL_V2
- local desplegado y sincronizado: TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_19_0_STORE_URL_V2
