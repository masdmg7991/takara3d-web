...
EXPECTED_CODE_SHA = (
    "DE707A620A695BF07FB98B84E1A35512"
    "3C05F7F9EA5A4DDBC70B970004DE0199"
)
EXPECTED_ORDER_BROWSER_SHA = (
    "856DA59F0807D462BD073C614F02FBB8"
    "B9FE45F66BC3E6D10EF8014C31782F15"
)
EXPECTED_ORDER_BROWSER_PROTOCOL = "TAKARA_ORDER_BROWSER_POSTMESSAGE_V1"
EXPECTED_LOCAL_VERSION = (
    "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_"
    "V1_19_0_STORE_URL_V2"
)
...
def main() -> int:
    ...
    require(
        ...
        "Code.gs conserva VERSION local candidata V1.19.0",
    )
    require(
