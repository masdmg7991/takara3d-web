...
BACKEND = "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_17_0_CONTACT_BROWSER_ACK_V1"
...
def validate_files() -> None:
    for path in (
        ...
        ORDER_JS, ORDER_HTML, CODE_GS, ORDER_CONTRACT, DEPLOYMENT, DEPLOYMENT_STATE, SEO_CONTRACT,
    ):
...
def validate_docs() -> None:
    ...
    require(
        ...
        "Estado mecanico fija candidato local V1.17.0",
    )
    require(
    ...
    require(BACKEND in deployment, "DEPLOYMENT documenta candidato local V1.17.0")
    require(
