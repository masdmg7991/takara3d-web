...
BACKEND = "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_20_0_STORE_PICKUP"
...
def validate_docs() -> None:
    ...
    require(
        ...
        "Estado mecanico fija V1.20.0 candidato",
    )
    require(
    ...
    require(BACKEND in deployment, "DEPLOYMENT documenta V1.20.0 candidato")
    require(
