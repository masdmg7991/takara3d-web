...
function main() {
  ...
  ok(source.includes('TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_20_0_STORE_PICKUP'), "Versión dual-stack presente");
  ...
  ok(
    dryRun.script === "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_20_0_STORE_PICKUP",
