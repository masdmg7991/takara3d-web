...
function main() {
  ...
  ok(source.includes('TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_17_0_CONTACT_BROWSER_ACK_V1'), "Versión dual-stack presente");
  ...
  ok(
    dryRun.script === "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_17_0_CONTACT_BROWSER_ACK_V1",
