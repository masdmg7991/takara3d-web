...
function main() {
  ...
  ok(source.includes('TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_19_0_STORE_URL_V2'), "Versión dual-stack presente");
  ...
  ok(
    dryRun.script === "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_19_0_STORE_URL_V2",
