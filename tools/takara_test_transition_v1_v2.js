...
function main() {
  ...
  ok(source.includes('TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_15_0_ORDER_IDEMPOTENCY_V1'), "Versión dual-stack presente");
  ...
  ok(
    dryRun.script === "TAKARA_PEDIDOS_WEB_APPS_SCRIPT_V1_15_0_ORDER_IDEMPOTENCY_V1",
